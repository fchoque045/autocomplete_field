...
class profile_define_autocomplete extends profile_define_base {
    ...
    public function define_form_specific($form) {
        ...
        $form->addElement('textarea', 'param1', get_string('optionsfromchoice', 'profilefield_autocomplete'), array('rows' => 6, 'cols' => 80));
        $form->setType('param1', PARAM_TEXT);
        $form->addHelpButton('param1', 'optionsfromchoice', 'profilefield_autocomplete');
        
        // Default data.
        $form->addElement('text', 'defaultdata', get_string('optiondefault', 'profilefield_autocomplete'), 'size="50"');
        $form->setType('defaultdata', PARAM_TEXT);
        $form->addHelpButton('defaultdata', 'optiondefault', 'profilefield_autocomplete');
    }
